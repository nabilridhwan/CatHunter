...
export const ConfirmUser = () => {
  ...
  return <Container maxW={'4xl'}>
    <Stack>
      ...
      <Text>
        An email has been sent to your email address. Please enter the verification code to confirm your
        account.
      </Text>
      ...
      <form onSubmit={handleSubmit}>
        <Input
          ...
          }} type={'text'} name={'code'} placeholder={'Verification Code'}/>
        <Button
          isDisabled={!values.code}
          type={'submit'}
          variant={'solid'}>Confirm</Button>
      </form>

      <Text>
        Didn't receive the email? <Button onClick={handleResendVerificationCode}>Resend</Button>
      </Text>
    </Stack>
  </Container>
