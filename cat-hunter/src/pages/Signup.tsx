import {Button, Container, FormControl, FormErrorMessage, Input, InputGroup, Link, Stack, Text} from "@chakra-ui/react";
...
const signUpFormSchema = yup.object({
  ...
  confirm_password: yup.string().required("Please re-enter your password").oneOf([yup.ref('password')], 'Your passwords do not match.'),
})
...
export const Signup = () => {
  ...
  return <Container maxW={'4xl'} my={10}>
    ...
    <form onSubmit={handleSubmit}>
      <Stack>
        ...
        <Button
          ...
          isDisabled={!isValid || !dirty} variant={'solid'}>Sign Up</Button>
